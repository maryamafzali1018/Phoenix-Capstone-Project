...
Feature: Laptop & NoteBooks
  ...
  Scenario: Add and Remove a MacBook from Cart
    ...
    Then User should see macBook success message "Success: You have added MacBook to your shopping cart!"
  ...
  Scenario: Product Comparison
    ...
    And User click on MacBook Air comparison icon on "MacBook Air"
